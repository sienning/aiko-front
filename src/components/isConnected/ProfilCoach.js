...
import '../../App.css';
import { Container, Header, Image, Grid, GridColumn, Button, Loader } from 'semantic-ui-react'
                ...
                }
                {
                    isLoading ?
                        ...
                        userInfos.calendlyCoach ?
                            <InlineWidget url={`https://calendly.com/${userInfos.calendlyCoach}`} style={{ overflowY: "hidden" }} />
                            :
                            <div></div>
                }
